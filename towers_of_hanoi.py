...
class Game:
    ...
    def move(self, from_stack, to_stack):
        ...
        if  first_stack.is_empty():
            ...
            message += '!!!!!!!!!!!!!!!!!!!!!!!!!!!!!'
            return message
        elif (not second_stack.is_empty()) and (int(first_stack.peek()) > int(second_stack.peek())):
            message = '!!!!!!!!!!!!!!!!!!!!!!!!!!!!!'
...
###################################
    ...
    print(f'\nFor {num_disks} disks, the optimal number of moves is {game.min_moves()}\n')
    ...
    print('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
    print(f'\nWell done! You completed the game in {game.get_num_moves()} moves compared to the minimum possible number of {game.min_moves()}.\n')
    print('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
